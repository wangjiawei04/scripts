...
#     pip install opencv-python==4.2.0.32 
    ...
    wget https://paddle-wheel.bj.bcebos.com/0.0.0-gpu-cuda10-cudnn7-mkl/paddlepaddle_gpu-0.0.0-cp27-cp27m-linux_x86_64.whl --no-check-certificate
...
#     mv 1.8.3-gpu-cuda10-cudnn7-mkl%2Fpaddlepaddle_gpu-1.8.3.post107-cp27-cp27mu-linux_x86_64.whl paddlepaddle_gpu-1.8.3.post107-cp27-cp27mu-linux_x86_64.whl
    ...
    /opt/_internal/cpython-2.7.15-ucs4/bin/python -m pip install paddlepaddle_gpu-0.0.0-cp27-cp27m-linux_x86_64.whl

function run_bert_base128() {
    echo "bert base128 begin run"
    bert_base=${benchmark_path}/FleetX/2.0benchmark/collective/bert_base_max128
    ...
    echo "bert base max128 jobs submit over"
}

...
/***************************************************************************
  ...
  * @file test_dist_fleet_transformer.py
  * @author liyang109@baidu.com
  * @date 2020-05-18 2:26
  * @brief
  *
  **************************************************************************/
"""
...
class TestDistBert(TestFleetBase):
    ...
    def __init__(self):
        ...
        self.single_sync_gpu_data = [8.664551, 8.579489, 8.534114, 8.413928, 8.48873]
        self._model_file = 'dist_fleet_transformer.py'
    ...
    def test_1tr_2gpu_nccl_fp16_Tei_nn2_Tlsgd_mc_cl(self):
        """test_1tr_2gpu_nccl_fp16_Tei_nn2_Tlsgd_mc_cl."""
        TestFleetBase.__init__(self, pservers=0, trainers=1)
        self.run_params = {
            'fp16': False,
            'num_threads': 2,
    ...
    def test_1tr_2gpu_nccl_fp16_Fei_nn2_Tlsgd_mc_cl(self):
        """test_1tr_2gpu_nccl_fp16_Fei_nn2_Tlsgd_mc_cl."""
        TestFleetBase.__init__(self, pservers=0, trainers=1)
        self.run_params = {
            'fp16': False,
            'num_threads': 2,
    ...
    def test_1tr_2gpu_nccl_fp16_Tei_nn2_Flsgd_mc_cl(self):
        """test_1tr_2gpu_nccl_fp16_Tei_nn2_Flsgd_mc_cl."""
        TestFleetBase.__init__(self, pservers=0, trainers=1)
        self.run_params = {
            'fp16': False,
            'num_threads': 2,
    ...
    def test_1tr_2gpu_nccl_fp16_Fei_nn2_Flsgd_mc_cl(self):
        """test_1tr_2gpu_nccl_fp16_Fei_nn2_Flsgd_mc_cl."""
        TestFleetBase.__init__(self, pservers=0, trainers=1)
        self.run_params = {
            'fp16': False,
            'num_threads': 2,
    ...
    def test_1tr_2gpu_nccl_fp16_Tei_nn2_Flsgd_mn_cn(self):
        """test_1tr_2gpu_nccl_fp16_Tei_nn2_Flsgd_mn_cn."""
        TestFleetBase.__init__(self, pservers=0, trainers=1)
        self.run_params = {
            'fp16': False,
            'num_threads': 2,

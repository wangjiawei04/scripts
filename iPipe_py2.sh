...
rpc_model_list=(bert_rpc_gpu bert_rpc_cpu faster_rcnn_model_rpc ResNet50_rpc ResNet101_rpc criteo_ctr_rpc criteo_ctr_gpu_rpc lac_rpc cnn_rpc bow_rpc lstm_rpc fit_a_line_rpc)
...
function lac_http() {
  ...
  run_cpu_env
  cd ${build_path}/python/examples/lac
  python lac_web_service.py jieba_server_model/ lac_workdir 8872 > http_lac_log2 2>&1 &
  tail http_lac_log2
  sleep 10

...
rpc_model_list=(bert_rpc_gpu bert_rpc_cpu faster_rcnn_model_rpc ResNet50_rpc ResNet101_rpc lac_rpc criteo_ctr_rpc criteo_ctr_gpu_rpc cnn_rpc bow_rpc lstm_rpc fit_a_line_rpc)
